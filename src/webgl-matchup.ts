...
import {create} from './webgl-core';
import {Field} from './webgl-field';
import {Pitch} from './webgl-pitch';
import {StrikeZone} from './webgl-strikezone';
...
export class AtBat {
  ...
  drawScene() {
    ...
    // mat4.perspective(
    //     this.pMatrix, 45, gl.viewportWidth / gl.viewportHeight, 0.1, 500.0);
